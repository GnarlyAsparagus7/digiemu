...
MAIN OS carries a serial command console -- its handshake is `#HELLO` /
`HOW DO YOU DO?`; the rest of the command set is factory service
functionality, not listed here -- spoken over UART8 (identified from NXP
MCF54418RM, Table 1-4 / ch. 41):
